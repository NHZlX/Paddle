...
TEST(SoftMaxOpConverter, main) {
  ...
  // The Softmax of the fluid only support the input with two dimensions.
  // The first dim is batch size, the second represents channel size.
  // We set batchsize to 8 here.
